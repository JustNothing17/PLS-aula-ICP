...
# [MODIFICADO] Sem tratamentos. A matriz X_tratado recebe diretamente os dados brutos X
X_tratado <- X
...
plot(valores_reais, valores_preditos,
     ...
     main = "Regressão por Penalized PLS (Dados Brutos Puros)",
